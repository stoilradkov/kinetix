...
function AboutPage(): React.JSX.Element {
    return (
        <main className="mx-auto max-w-4xl px-6 py-12">
            ...
            <h1 className="mt-2 text-4xl font-semibold tracking-tight">Conventional where it matters.</h1>
            <p className="text-muted-foreground mt-4 max-w-2xl text-lg">
                Each layer is independently buildable and deployable, while shared packages keep contracts and
