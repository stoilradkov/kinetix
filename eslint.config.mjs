...
export default tseslint.config(
        ...
        rules: {
            ...
            "react-refresh/only-export-components": [
                "warn",
                {
                    ...
                    allowExportNames: ["Route", "buttonVariants", "badgeVariants", "tabsListVariants"],
                },
            ],
        },
    },
    ...
    {
        // Vendored shadcn chart wrapper over recharts, whose upstream types surface
        // `any`; relax only the type-aware checks this generated file trips.
